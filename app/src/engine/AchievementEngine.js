...
export const ACHIEVEMENTS = [
  ...
  { id: 'streak_3',   name: '3-Day Streak',  hint: 'Use Claudagotchi 3 days in a row',  check: s => consecutiveStreak(s.lastActiveDates) >= 3 },
  { id: 'streak_7',   name: '7-Day Streak',  hint: 'Use Claudagotchi 7 days in a row',  check: s => consecutiveStreak(s.lastActiveDates) >= 7 },
  { id: 'streak_30',  name: '30-Day Streak', hint: 'Use Claudagotchi 30 days in a row', check: s => consecutiveStreak(s.lastActiveDates) >= 30 },
